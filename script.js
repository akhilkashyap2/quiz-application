...
function showQuestion() {
    ...
    currentQuestions.forEach((question, index) => {
        ...
        const questionContainer = document.createElement("div"); // Create a container for the question and flag image
        ...
        flagImage.alt = "Flag";
        flagImage.classList.add("flag-image"); // Add a class for styling
        questionContainer.appendChild(flagImage);

        answerButtons.appendChild(questionContainer); // Append the container to the answer buttons div
